"""Validation for Gao et al. session momentum strategy."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Gao session momentum validation")
    parser.add_argument(
        "--config",
        default=str(ROOT / "config" / "strategy_gao_session_momentum.yaml"),
    )
    parser.add_argument(
        "--export-csv",
        default=None,
